...
package org.photonvision.tensorrt;

import org.opencv.core.Point;
import org.opencv.core.Rect2d;

public class TensorRTJNI {
    ...
    public static class TensorRTResult {
        public TensorRTResult(int left, int top, int right, int bottom, float conf, int class_id) {
            this.conf = conf;
        ...
        public String toString() {
            return "TensorRTResult [rect=" + rect + ", conf=" + conf + ", class_id=" + class_id + "]";
        }
        ...
        public boolean equals(Object obj) {
            ...
            TensorRTResult other = (TensorRTResult) obj;
            if (rect == null) {
    ...
    /**
     * Create a TensorRT detector. Returns valid pointer on success, or NULL on error
     *
     ...
     * @param boxThresh
     */
    public static native TensorRTResult[] detect(
